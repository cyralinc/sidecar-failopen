...
func TestParseOptString(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				cfg: config.RepoConfig{
					PGConfig: config.PostgreSQLConfig{ConnectionStringOptions: "this=that"},
				},
			},
			want: "?this=that",
		},
		{
			...
			args: args{
				cfg: config.RepoConfig{
					PGConfig: config.PostgreSQLConfig{ConnectionStringOptions: "this=that,that=this"},
				},
			},
		...
		},
		{
			...
			args: args{
				cfg: config.RepoConfig{
					PGConfig: config.PostgreSQLConfig{ConnectionStringOptions: ""},
				},
			},
			want: "",
		},
